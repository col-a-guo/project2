...
# 4. Locked-in Hyperparameters
best_params = (32, 4, 'Adam', 50)  # (hidden_size, num_layers, optimizer, window_size)
dropout_rate = 0.2 #Experiment with higher dropout
...
plot_lift_chart(test_y.flatten(), predicted.flatten())